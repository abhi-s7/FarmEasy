/**
 * Bright Data MCP Demo with LangChain
...
async function runMcpStyleDemo(query = 'AI news 2025') {
  try {
    if (!process.env.GOOGLE_API_KEY) {
      console.log('GOOGLE_API_KEY not set. This demo requires an LLM.');
    ...
    const systemPrompt = `
You are a researcher with access to Bright Data's tools:
